...
const ChangeImage = () => {
    ...
    return (
        <div className='edit-box'>
            <label onDrop={(e) => handleDrop(e)} onDragOver={(e) => e.preventDefault()} htmlFor='changeImage'>
                {
                    url ? <img className='max-h-[200px]' src={url} alt="" /> :
                        <div className="text-center h-[200px] border px-4 py-4 flex items-center justify-center flex-col">
                ...
                <input onChange={(e) => handleInputChange(e)} hidden accept='image/*' type="file" name="" id="changeImage" />
                {
                    url ? <div className="flex mt-4 justify-end">
