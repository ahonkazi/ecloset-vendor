        ...
        <table className="w-full">
            <thead>
                <tr>
                    ...
                    <th className="px-3 py-3 font-bold text-sm uppercase bg-Green text-white text-start">Product name</th>
                    <th className="px-3 py-3 font-bold text-sm uppercase bg-Green text-white text-start">Category</th>
            ...
            <tbody>
                {
                    [...new Array(10)].map(item =>
                        <tr className="bg-white lg:hover:bg-gray-50 select-none mb-10 ">
                            ...
                            <td className="wpx-3 py-1 text-gray-800  text-start  min-w-[150px]">
                                Men's fahions
                            </td>
